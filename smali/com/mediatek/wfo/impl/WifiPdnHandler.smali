...
.method static bridge synthetic -$$Nest$fputmIsAirplaneModeChange(Lcom/mediatek/wfo/impl/WifiPdnHandler;Z)V
    .locals 0
...
.method static bridge synthetic -$$Nest$fputmIsAirplaneModeOn(Lcom/mediatek/wfo/impl/WifiPdnHandler;Z)V
    .locals 0
...
.method static bridge synthetic -$$Nest$misEccInProgress(Lcom/mediatek/wfo/impl/WifiPdnHandler;)Z
    .locals 0
...
.method public constructor <init>(Landroid/content/Context;ILandroid/os/Looper;[Lcom/mediatek/wfo/ril/MwiRIL;)V
    ...
    .line 551
    new-instance v0, Lcom/mediatek/wfo/impl/WifiPdnHandler$2;

    invoke-direct {v0, p0}, Lcom/mediatek/wfo/impl/WifiPdnHandler$2;-><init>(Lcom/mediatek/wfo/impl/WifiPdnHandler;)V
...
.method private allowWfcInAirplaneMode()Z
    ...
    .line 1176
    invoke-direct {p0, v3, v1, v2}, Lcom/mediatek/wfo/impl/WifiPdnHandler;->getBooleanCarrierConfig(Ljava/lang/String;IZ)Z
    ...
    .local v1, "i":I
    :goto_0
    iget v4, p0, Lcom/mediatek/wfo/impl/WifiPdnHandler;->mSimCount:I
...
.method private getPhoneStateListener(II)Landroid/telephony/PhoneStateListener;
    ...
    new-instance v3, Lcom/mediatek/wfo/impl/WifiPdnHandler$1;

    invoke-direct {v3, p0, v0}, Lcom/mediatek/wfo/impl/WifiPdnHandler$1;-><init>(Lcom/mediatek/wfo/impl/WifiPdnHandler;I)V
...
.method private setWifiEnabled()V
    ...
    .line 1121
    const-string v4, "setWifiEnabled(): update mIsAirplaneModeOn from settings"
    ...
    const-string v5, "Can not get AIRPLANE_MODE_ON from provider."
    ...
    .line 1133
    const-string v4, "allowWfcInAirplaneMode: false"
    ...
    iget-boolean v6, p0, Lcom/mediatek/wfo/impl/WifiPdnHandler;->mIsAirplaneModeOn:Z
    ...
    invoke-virtual {v4, v5, v3, v2, v0}, Lcom/mediatek/wfo/ril/MwiRIL;->setWifiEnabled(Ljava/lang/String;IILandroid/os/Message;)V
...
.method private updateWifiConnectedInfo(I)V
    ...
    iget-object v4, v1, Lcom/mediatek/wfo/impl/WifiPdnHandler;->mWifiApMac:Ljava/lang/String;
    ...
    .local v3, "ipv6Gateway":Ljava/lang/String;
    .local v5, "dnsServers":Ljava/util/List;, "Ljava/util/List<Ljava/net/InetAddress;>;"
    .local v6, "mtu":I
    ...
    .line 991
    .local v14, "linkAddr":Landroid/net/LinkAddress;
    ...
    .end local v14    # "linkAddr":Landroid/net/LinkAddress;
    .local v9, "ipv6Address":Ljava/lang/String;
    ...
    .line 1010
    .end local v5    # "dnsServers":Ljava/util/List;, "Ljava/util/List<Ljava/net/InetAddress;>;"
    ...
    .end local v11    # "ifName":Ljava/lang/String;
    ...
    .local v6, "mtu":I
    .local v8, "ipv4Address":Ljava/lang/String;
    .restart local v11    # "ifName":Ljava/lang/String;
    :cond_14
    move-object/from16 v16, v4
    ...
    .line 1031
    iput-object v2, v1, Lcom/mediatek/wfo/impl/WifiPdnHandler;->mWifiIpv4Gateway:Ljava/lang/String;
    ...
    const-string v7, "updateWifiConnectedInfo(): mWifiIpv4Address = "

    invoke-virtual {v0, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v0

    iget-object v7, v1, Lcom/mediatek/wfo/impl/WifiPdnHandler;->mWifiIpv4Address:Ljava/lang/String;
    ...
    .line 1039
    iput-object v3, v1, Lcom/mediatek/wfo/impl/WifiPdnHandler;->mWifiIpv6Gateway:Ljava/lang/String;
    ...
    const-string v7, "updateWifiConnectedInfo(): mWifiIpv6Address = "

    invoke-virtual {v0, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v0

    iget-object v7, v1, Lcom/mediatek/wfo/impl/WifiPdnHandler;->mWifiIpv6Address:Ljava/lang/String;
    ...
    :goto_10
    iget-object v7, v1, Lcom/mediatek/wfo/impl/WifiPdnHandler;->mSsid:Ljava/lang/String;
    ...
    :goto_11
    iput-object v7, v1, Lcom/mediatek/wfo/impl/WifiPdnHandler;->mSsid:Ljava/lang/String;
    ...
    .line 1058
    iget-object v7, v1, Lcom/mediatek/wfo/impl/WifiPdnHandler;->mDnsServers:Ljava/util/List;
    ...
    .line 1064
    .local v7, "common":Ljava/util/List;, "Ljava/util/List<Ljava/net/InetAddress;>;"
    invoke-interface {v7, v5}, Ljava/util/List;->retainAll(Ljava/util/Collection;)Z
    ...
    .line 1057
    .end local v7    # "common":Ljava/util/List;, "Ljava/util/List<Ljava/net/InetAddress;>;"
    ...
    .line 1081
    .end local v0    # "changed":Z
    .end local v2    # "ipv4Gateway":Ljava/lang/String;
    .end local v3    # "ipv6Gateway":Ljava/lang/String;
    .end local v5    # "dnsServers":Ljava/util/List;, "Ljava/util/List<Ljava/net/InetAddress;>;"
    .end local v6    # "mtu":I
    .end local v8    # "ipv4Address":Ljava/lang/String;
    .end local v9    # "ipv6Address":Ljava/lang/String;
